...
public class RotateScreen extends RequestHandler {
  ...
  public RotateScreen(HttpRequest request, String mappedUri) {
  ...
  public Response handle() throws JSONException {
    ...
    String orientation = getPayload().getString("orientation");

    getSelendroidDriver().rotate(ScreenOrientation.valueOf(orientation));
